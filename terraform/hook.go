...
type Hook interface {
	...
	PreApply(addr addrs.AbsResourceInstance, gen states.Generation, priorState, plannedNewState cty.Value) (HookAction, error)
	...
	PostDiff(addr addrs.AbsResourceInstance, priorState, plannedNewState cty.Value) (HookAction, error)
	...
	PostRefresh(addr addrs.AbsResourceInstance, priorState cty.Value, newState cty.Value) (HookAction, error)
...
func (*NilHook) PreApply(addr addrs.AbsResourceInstance, gen states.Generation, priorState, plannedNewState cty.Value) (HookAction, error) {
...
func (*NilHook) PreDiff(addr addrs.AbsResourceInstance, priorState, proposedNewState cty.Value) (HookAction, error) {
	return HookActionContinue, nil
}

func (*NilHook) PostDiff(addr addrs.AbsResourceInstance, priorState, plannedNewState cty.Value) (HookAction, error) {
	return HookActionContinue, nil
}
...
func (*NilHook) PreRefresh(addr addrs.AbsResourceInstance, priorState cty.Value) (HookAction, error) {
	return HookActionContinue, nil
}

func (*NilHook) PostRefresh(addr addrs.AbsResourceInstance, priorState cty.Value, newState cty.Value) (HookAction, error) {
	return HookActionContinue, nil
}
